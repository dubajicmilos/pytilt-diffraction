...
This file tests the program with a 2x2x2 supercell.

The lattice constant of CsSnI3  6.219A. 
A  **2X2X2** supercell is sufficient to show the structural change.
...
class Tests(unittest.TestCase):
    """
    Set the rotation of 23 tilt systems.
    """
